...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-md">
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6">
            <h1 class="text-white text-3xl font-semibold text-center">Welcome Back</h1>
        </div>
        <div class="p-8">
            <form action="process_login.php" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="password" id="password" required class="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-150" placeholder="Your password">
                </div>
